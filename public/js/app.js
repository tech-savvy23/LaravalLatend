...
(function (factory) {
  ...
  Slick.prototype.buildArrows = function () {
    ...
    if (_.options.arrows === true && _.slideCount > _.options.slidesToShow) {
      _.$prevArrow = $('<button type="button" class="slick-prev" tabIndex="-1">Previous</button>').appendTo(_.$slider);
      _.$nextArrow = $('<button type="button" class="slick-next" tabIndex="-1">Next</button>').appendTo(_.$slider);
  ...
  Slick.prototype.buildDots = function () {
    ...
    if (_.options.dots === true && _.slideCount > _.options.slidesToShow) {
      ...
      for (i = 0; i <= _.getDotCount(); i += 1) {
        dotString += '<li><a href="javascript:void(0)" tabIndex="-1">' + i + '</a></li>';
      }
    ...
    if (_.options.infinite === true && _.options.fade === false) {
      ...
      if (_.slideCount > _.options.slidesToShow) {
        ...
        for (i = _.slideCount; i > _.slideCount - infiniteCount; i -= 1) {
          slideIndex = i - 1;
          $(_.$slides[slideIndex]).clone().prependTo(_.$slideTrack).addClass('slick-cloned');
        }

        for (i = 0; i < infiniteCount; i += 1) {
          slideIndex = i;
          $(_.$slides[slideIndex]).clone().appendTo(_.$slideTrack).addClass('slick-cloned');
        }
      }
    }
  };
...
/***/ 0:
/*!*****************************************************************************************************************************!*\
  !*** multi ./resources/js/jquery-1.10.2.min.js ./resources/js/easing.js ./resources/js/move-top.js ./resources/js/slick.js ***!
  \*****************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /home/manpreet/laravel/perfect-house/resources/js/jquery-1.10.2.min.js */"./resources/js/jquery-1.10.2.min.js");
__webpack_require__(/*! /home/manpreet/laravel/perfect-house/resources/js/easing.js */"./resources/js/easing.js");
__webpack_require__(/*! /home/manpreet/laravel/perfect-house/resources/js/move-top.js */"./resources/js/move-top.js");
module.exports = __webpack_require__(/*! /home/manpreet/laravel/perfect-house/resources/js/slick.js */"./resources/js/slick.js");
